...
public class XmlReportFileTest {
    ...
    public void testExists() {
        ZapSensorConfiguration configuration = mock(ZapSensorConfiguration.class);
        when(configuration.getReportPath()).thenReturn("src/test/resources/report/zaproxy-report.xml");
    ...
    public void testWrongPathExists() {
        ZapSensorConfiguration configuration = mock(ZapSensorConfiguration.class);
        when(configuration.getReportPath()).thenReturn("/do/not/exist/zaproxy-report.xml");
    ...
    public void testInputStream() throws IOException {
        ZapSensorConfiguration configuration = mock(ZapSensorConfiguration.class);
        when(configuration.getReportPath()).thenReturn(System.getProperty("user.dir") + File.separator + "src/test/resources/report/zaproxy-report.xml");
