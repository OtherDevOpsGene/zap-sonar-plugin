...
public final class ZapMetrics implements Metrics {
  ...
  public static final Metric HIGH_RISK_ALERTS = new Metric.Builder(HIGH_RISK_ALERTS_KEY,
      "High Risk Alerts", Metric.ValueType.INT)
      ...
      .setHidden(false)
      .create();
  public static final Metric MEDIUM_RISK_ALERTS = new Metric.Builder(MEDIUM_RISK_ALERTS_KEY,
      "Medium Risk Alerts", Metric.ValueType.INT)
      ...
      .setHidden(false)
      .create();
  public static final Metric LOW_RISK_ALERTS = new Metric.Builder(LOW_RISK_ALERTS_KEY,
      "Low Risk Alerts", Metric.ValueType.INT)
      ...
      .setHidden(false)
      .create();
  public static final Metric INFO_RISK_ALERTS = new Metric.Builder(INFO_RISK_ALERTS_KEY,
      "Info Risk Alerts", Metric.ValueType.INT)
      ...
      .setHidden(false)
      .create();
  public static final Metric TOTAL_ALERTS = new Metric.Builder(TOTAL_ALERTS_KEY, "Total Alerts",
